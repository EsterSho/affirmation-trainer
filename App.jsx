...
// Affirmation Trainer — Single-file React component (Tailwind CSS assumed)
// Features:
// - 3 eternal affirmations (editable)
// - daily counters with quick "✅" taps
// - history (last 90 days) saved to localStorage (offline-ready)
// - weekly expanded ritual modal
// - help (?) with detailed instructions how to repeat with slide + feeling
// - simple visualizations: streak, mini bar chart
// - voice playback (SpeechSynthesis) and optional voice recording (browser)
// - PWA service worker registration hook (requires service worker file + manifest in hosting)
...
export default function AffirmationTrainer() {
